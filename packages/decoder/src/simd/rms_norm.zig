...
pub fn compute(input_vector: []const f32, weight_vector: []const f32, output_vector: []f32) void {
    ...
    hadamard_product.compute(output_vector, weight_vector, output_vector);
}
...
test "compute rms norm" {
    ...
    compute(&input_vector, &weight_vector, output_vector);
